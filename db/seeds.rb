...
animal1 = Animal.create!(name: 'Titi', category: 'Exotic', species: 'Tiger', description: 'wild tiger rescued from illegal hunting', address: '69 avenue de Villiers, 75017 Paris', age: 17, price_per_day: 200, user: youri)
...
animal2 = Animal.create!(name: 'Wiwi', category: 'Reptile', species: 'Boa', description: 'sleepy boa who can eat a whole pigeon at once', address: '56 boulevard Garibaldi, 75015 Paris', age: 12, price_per_day: 30, user: youri)
...
animal3 = Animal.create!(name: 'Tutus', category: 'Pet', species: 'Cat', description: 'nice black cat who love to eat and play', address: '11 rue des Cloys, 75018 Paris', age: 6, price_per_day: 40, user: youri)
...
animal4 = Animal.create!(name: 'Josh', category: 'Exotic', species: 'Lemur', description: 'crazy lemur always prone to play', address: '74 avenue de Clichy, 75017 Paris', age: 3, price_per_day: 75, user: youri)
...
animal5 = Animal.create!(name: 'Dumbo', category: 'Exotic', species: 'Elephant', description: 'impress your friends with this massive Asian elephant', address: '1 rue du Louvre, 75001 Paris', age: 24, price_per_day: 400, user: youri)
...
animal6 = Animal.create!(name: 'Lea', category: 'Pet', species: 'Cat', description: 'the famous cat from the meme', address: '10 Rue Perronet, 75007 Paris', age: 12, price_per_day: 60, user: audrey)
...
animal7 = Animal.create!(name: 'Pedro', category: 'Bird', species: 'Parrot', description: 'English speaking parrot who loves to sing', address: '12 Rue du Dr Charles Richet, 75013 Paris', age: 12, price_per_day: 30, user: audrey)
...
animal8 = Animal.create!(name: 'Momo', category: 'Bird', species: 'Colibri', description: 'the tiniest bird ever', address: '38 Rue de Joinville, 75019 Paris', age: 2, price_per_day: 25, user: audrey)
...
animal9 = Animal.create!(name: 'Chimp', category: 'Exotic', species: 'Monkey', description: 'fun chimpanzee constantly on the move', address: '60 Rue Blanche, 75009 Paris', age: 10, price_per_day: 55, user: audrey)
...
animal10 = Animal.create!(name: 'Brutus', category: 'Pet', species: 'Dog', description: 'fun American staff who loves to chase stuff', address: '19 Rue de Montmorency, 75003 Paris', age: 7, price_per_day: 40, user: audrey)
...
animal11 = Animal.create!(name: 'Lone', category: 'Exotic', species: 'Giraffe', description: 'Long ass giraffe spending days eating leafs', address: '76 Rue Vieille du Temple, 75003 Paris', age: 13, price_per_day: 190, user: aymeric)
...
animal13 = Animal.create!(name: 'Gogo', category: 'Pet', species: 'Goat', description: 'the goat of the goats', address: '29 Rue des Boulangers, 75005 Paris', age: 4, price_per_day: 45, user: aymeric)
...
animal14 = Animal.create!(name: 'Chichi', category: 'Amphibian', species: 'Frog', description: 'nice female frog, champion jumper', address: '19 Rue Crozatier, 75012 Paris', age: 10, price_per_day: 130, user: aymeric)
...
animal15 = Animal.create!(name: 'Nero', category: 'Exotic', species: 'Panther', description: 'crazy-looking black panther', address: '6 Rue Saint-Didier, 75016 Paris', age: 11, price_per_day: 165, user: aymeric)
